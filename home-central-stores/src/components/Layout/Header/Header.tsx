...
export default function Header() {
    ...
    return <header className=" bg-[var(--secondary-500-main)] w-full ">
        <div className="baseContainer flex justify-center items-center py-[1rem] text-white lg:justify-between">
