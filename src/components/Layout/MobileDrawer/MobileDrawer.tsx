...
export default function MobileDrawer({ isOpen, onClose }: MobileDrawerProps) {
  ...
  return (
    <div
      className={`baseContainer absolute lg:hidden top-full left-0 w-full bg-white z-50 transition-all duration-300 ease-in-out ${
        isOpen
    ...
    >
      <div className="p-[2rem] bg-[var(--Secondary-50)] flex flex-col ">
        <div className="flex text-[1.25rem] font-medium">
          <span
            className={`p-[1rem] flex-1 rounded-[var(--Radius-md)] text-center cursor-pointer transition-all duration-300 ease-in-out flex items-center justify-center ${
              activeTab === "main"
          ...
          <span
            className={`p-[1.5rem] flex-1 rounded-[var(--Radius-md)] text-center cursor-pointer transition-all duration-300 ease-in-out flex items-center justify-center ${
              activeTab === "shop"
                ? "bg-[var(--Secondary-100)]"
                : "bg-transparent hover:bg-[var(--Secondary-100)]/50"
            }`}
