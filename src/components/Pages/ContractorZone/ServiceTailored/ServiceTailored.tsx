        ...
        <div className="baseContainer py-[2.5rem]">
            <div className="maxWidth flex flex-col items-center gap-[1.5rem] bg-[var(--Teritary-100)] rounded-[var(--Radius-md)] p-[2.5rem]">
                ...
                <div className="w-full overflow-x-auto lg:overflow-visible">
                    <div className="flex gap-[1.75rem] w-max lg:w-full lg:grid lg:grid-cols-3">
                        {contractorServices.map((service, index) => (
                            <div
                                key={index}
                                className="w-[280px] sm:w-[320px] flex-shrink-0 lg:w-auto lg:flex-shrink p-[1.5rem] flex flex-col gap-[1rem] bg-white rounded-[var(--Radius-md)]"
                            >
