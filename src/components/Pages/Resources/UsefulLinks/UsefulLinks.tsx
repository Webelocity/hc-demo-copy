        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="bg-[#181464] rounded-2xl p-6 md:p-10 lg:row-span-2">
            <div className="flex flex-col gap-10 h-full justify-center py-4">
              <h2 className="font-sora font-bold text-white text-[2rem] sm:text-[2.5rem] leading-[1.2] tracking-[0.05rem]">
                ...
                {calculatorLinks.map((link, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-center gap-2 py-4">
                      <span className="font-sora font-semibold text-white text-[1.125rem] leading-[1.2] tracking-[0.0225rem]">
                        {link.title}
                      </span>
                      <svg
                        width="16"
