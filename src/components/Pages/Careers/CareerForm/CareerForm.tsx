    ...
    const onNext = async () => {
        ...
        if (activeStep === 0) {
            ...
            fieldsToValidate.push(
                ...
                "employmentData.whenCanYouStart",
                ...
                <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-8">
                    ...
                    {activeStep === 0 && (
                        <div className="space-y-6">
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <FormControl required error={!!errors.demographicInformation?.referredBy}>
                                            <InputLabel>How ere you refered</InputLabel>
                                            <Select label="How ere you refered" {...field}>
                            ...
                            <div className="flex justify-end gap-3">
                                <Button variant="contained" onClick={onNext} sx={{ backgroundColor: "var(--primary-500-main)" }}>Next</Button>
                            </div>
                        </div>
                    )}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                                <Controller
                                    ...
                                    rules={{ required: "Required" }}
                                    render={({ field }) => (
                                        <TextField {...field} type="text" label="Date Available to Start" required error={!!errors.employmentData?.dateAvailableToStart} helperText={errors.employmentData?.dateAvailableToStart?.message} />
                                    )}
                                />
                                <Controller
                                ...
                                />
                                <Controller
                                    name="employmentData.whenCanYouStart"
                                    control={control}
                                    rules={{ required: "Required" }}
                                    render={({ field }) => (
                                        <TextField {...field} type="date" label="When can you start" required InputLabelProps={{ shrink: true }} error={!!errors.employmentData?.whenCanYouStart} helperText={errors.employmentData?.whenCanYouStart?.message} />
                                    )}
                                />
                            </div>
                            ...
                            {/* Days able to work */}
                            <div>
                                <InputLabel>Days you are able to work</InputLabel>
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <FormControl required error={!!errors.employmentData?.workedForHomeCentralBefore}>
                                    <InputLabel shrink>Have you ever worked for Home Central?</InputLabel>
                                    <Controller
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <FormControl required error={!!errors.employmentData?.isUsCitizen}>
                                    <InputLabel shrink>Are you a citizen of the United States?</InputLabel>
                                    <Controller
                                ...
                                <FormControl required error={!!errors.employmentData?.legallyAllowedToWorkUs}>
                                    <InputLabel shrink>If not, are you legally allowed to work in the United States?</InputLabel>
                                    <Controller
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                                ...
                                <Controller
                                    ...
                                    rules={{ required: "Required" }}
                                    render={({ field }) => (
                                        <FormControl required error={!!errors.employmentData?.stateOfIssue}>
                    ...
                    {activeStep === 2 && (
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                ...
                                <Button variant="outlined" onClick={addExperience}>Add work experience</Button>
                            </div>
                            {fields.length === 0 && (
                                    ...
                                    <div key={field.id} className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                                            <Controller
                                                ...
                                                render={({ field }) => (
                                                    <TextField {...field} type="date" label="Start Date" InputLabelProps={{ shrink: true }} required={!!requiredNow} error={!!errors.previousEmploymentHistory?.[index]?.startDate} helperText={errors.previousEmploymentHistory?.[index]?.startDate?.message} />
                                                )}
                                            />
                                            <Controller
                                                ...
                                                rules={{ required: requiredNow ? "Required" : false }}
                                                render={({ field }) => (
                                                    <TextField {...field} type="date" label="End Date" InputLabelProps={{ shrink: true }} required={!!requiredNow} error={!!errors.previousEmploymentHistory?.[index]?.endDate} helperText={errors.previousEmploymentHistory?.[index]?.endDate?.message} />
                                                )}
                                            />
                                            <Controller
                    ...
                    {activeStep === 3 && (
                        <div className="space-y-6">
                            ...
                            <div>
                                <InputLabel>Addional Files (data uploader)</InputLabel>
                                <Controller
                            ...
                            <div className="flex justify-between gap-3">
                                <Button variant="outlined" onClick={onBack}>Back</Button>
                                <Button variant="contained" type="submit" sx={{ backgroundColor: "var(--primary-500-main)" }}>Submit Application</Button>
                            </div>
                        </div>
                    )}
                </form>
