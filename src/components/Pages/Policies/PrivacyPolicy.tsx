    ...
    <div className="flex flex-col gap-[1.5rem] items-start w-full">
      ...
      <div className="font-['Figtree'] font-normal leading-[1.5] text-[1.125rem] text-[var(--Neutral-700)] tracking-[0.0225rem] w-full">
        ...
        <p className="mb-4">
          ...
          <a
            ...
            className="text-[#841618] underline"
          >
      ...
      <PolicyTerm title="How We Use Collected Information">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            To improve our online presence and website to better meet the needs
            of our customers.
          </li>
      ...
      <PolicyTerm title="How Information May Be Shared">
        ...
        <p className="mb-4">
          Home Central may share generic information of an aggregated nature,
          not linked to any personal information, regarding our users purchasing
          habits.
        </p>
        <p className="mb-4">
          Home Central may share personal information in certain circumstance
          where required:
        </p>
        <ul className="list-disc pl-6 space-y-2 mb-4">
          <li>To comply with laws or legal processes or legal obligations.</li>
          <li>
      ...
      <PolicyTerm title="How We Protect Your Information">
        ...
        <p className="mb-4">
          ...
          material. To do so, please contact us by email at{" "}
          <a
            href="mailto:hc@homecentralstores.com"
            className="text-[#841618] underline font-semibold"
          >
            hc@homecentralstores.com
          </a>
          , or by letter to 151 Central Ave, Owego, NY 13827. We still reserve
          the right to send messages relating to your account, this site, and/or
          our policies.
        </p>
        <p>
      ...
      <PolicyTerm title="Right To Request or Delete Information">
        ...
        <p>
          You have the right to request all personal information which is being
          retained. You also have the right to request deletion of all personal
          information that we have collected, subject to certain exceptions. All
          ...
          acknowledged within 10 business days, with responses to requests
          within 45 days. We will notify you if additional time is needed to
      ...
      <PolicyTerm title="User's Acceptance of These Terms">
        <p>
          By using this Site, users signify their acceptance of this policy. If
          a user does not agree to this policy, please do not use our Site. A
          user's continued use of the Site following the posting of changes to
          this policy will be deemed their acceptance of those changes.
        </p>
      </PolicyTerm>
    </div>
  );
