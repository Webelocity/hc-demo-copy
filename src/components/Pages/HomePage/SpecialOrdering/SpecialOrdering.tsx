...
export default function SpecialOrdering() {
    return (
        <div className="baseContainer py-[2.5rem]">
            <div className="maxWidth bg-[var(--primary-500-main)] flex flex-col md:flex-row justify-between items-center gap-[1.5rem] w-full bg-[var(--Secondary-50)] rounded-[var(--Radius-md)]  ">
