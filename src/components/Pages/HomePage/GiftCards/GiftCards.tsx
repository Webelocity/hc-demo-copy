...
export default function GiftCards() {
    return (
        <div className="baseContainer py-[2.5rem]">
            <div className="p-[2.5rem] maxWidth flex flex-col justify-center items-center gap-[5rem] aspect-[1352/474] bg-[url('/assets/image/HomePage/Gift_Cards.svg')] rounded-[var(--Radius-md)] bg-cover bg-center bg-no-repeat">
