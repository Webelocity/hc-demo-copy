        ...
        <div className="baseContainer py-[2.5rem] ">
            <div className="flex flex-col md:flex-row gap-[2.5rem] p-[1.5rem] md:p-[2.5rem] bg-[var(--primary-500-main)] rounded-[var(--Radius-md)]">
                <div className="flex-[1] flex flex-col gap-[1rem]">
                    ...
                    <Image className="!relative object-contain !w-[38.5rem] !h-[28.5rem] rounded-[var(--Radius-md)]" src="/assets/image/OwegoShowroom/owegoVisit.svg" alt="reach-out" fill />
                </div>
                <div className="flex-[1] flex flex-col gap-[1.5rem] p-[1.5rem] bg-[var(--Primary-400)] rounded-[var(--Radius-md)]">
                    ...
                    <div className="flex flex-col ">
                        <div className="flex items-center gap-[0.25rem]">
                            <Image className="!relative !w-[1.25rem] !h-[1.25rem]" src="/assets/image/OwegoShowroom/location.svg" alt="location" fill />
                    ...
                    <div className="flex flex-col ">
                        <div className="flex items-center gap-[0.25rem]">
                            <Image className="!relative !w-[1.25rem] !h-[1.25rem]" src="/assets/image/OwegoShowroom/time.svg" alt="location" fill />
                            <p className="text-[1.125rem] text-white font-semibold text-start">
                                Opening Hours
                            </p>
                        </div>
