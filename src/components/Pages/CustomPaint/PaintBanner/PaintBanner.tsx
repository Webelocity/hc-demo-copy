export default function PaintBanner() {
    return (
        <div className="baseContainer py-[1.5rem] md:py-[3rem]">
            <div className="relative maxWidth p-[2.5rem] flex items-center justify-center min-h-[400px] md:min-h-[362px] bg-[url('/assets/image/HomePage/Paint.svg')] rounded-[1rem] md:rounded-[1.5rem] bg-cover bg-center bg-no-repeat overflow-hidden">
