    ...
    <div className='baseContainer py-[1.5rem]'>
      ...
      >
        ...
        <div className='relative z-10 flex flex-col gap-[2rem] items-center max-w-[45rem] text-center px-4'>
          <h1 className='text-white font-bold text-[2rem] sm:text-[2.5rem] md:text-[3rem] leading-[1.2] tracking-[0.06rem] '>
            Home Central Stores Team
          </h1>
          <p className='text-white font-bold text-[1.5rem] sm:text-[1.75rem] md:text-[2rem] leading-[1.2] tracking-[0.04rem] '>
