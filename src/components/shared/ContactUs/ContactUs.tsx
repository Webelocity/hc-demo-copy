  ...
  return (
    <div
      className={`  flex flex-col ${
        version === "contact"
          ? "lg:flex-row-reverse "
          : "baseContainer lg:flex-row py-[5rem]"
      }  gap-[2.5rem] items-center w-full `}
    >
      <div className="flex flex-col gap-[1.5rem] flex-1">
        {version === "home" && (
          <p className="text-[2.5rem] font-bold ">
            Reach Out to Home Central Stores
          </p>
        )}
        <Map size="medium" />
        <div className="flex  gap-[1.5rem] align-center">
          <div className="flex flex-col gap-[1rem]">
            ...
            <div className="flex flex-col ">
              <p className="text-[1rem] font-medium font-normal">
                151 Central Ave. Owego, NY 13827
              </p>
              <p className="text-[var(--secondary-500-main)] font-medium">
                (607) 687-3284
              </p>
            </div>
          </div>
