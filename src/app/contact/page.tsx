...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Contact Home Central Stores for hardware, building supplies, and contractor inquiries. Reach our team in Owego, Vestal, and Candor, NY for bulk orders, project support, and advice.",
  openGraph: {
    title: "Contact Us | Home Central Stores",
    description:
      "Get in touch with Home Central Stores – Owego, Vestal, and Candor, NY.",
  },
};
